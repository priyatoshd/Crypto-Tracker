package com.priyatosh.cryptotracker.crypto.presentation.coin_detail.components
...
import com.priyatosh.cryptotracker.crypto.presentation.coin_detail.ChartStyle
import com.priyatosh.cryptotracker.crypto.presentation.coin_detail.DataPoint
import com.priyatosh.cryptotracker.crypto.presentation.coin_detail.ValueLabel
    ...
    Canvas(
        ...
        xLabelTextLayoutResults.forEachIndexed { index, result ->
            val x = viewPortLeftX + xAxisLabelSpacingPx / 2f +
                    xLabelWidth * index
            val color = if(index == selectedDataPointIndex) style.selectedColor
        ...
        val heightRequiredForTheLabels = xLabelLineHeight *
                (labelCountExcludingLastLabel + 1)
        val remainingHeight = labelViewPortHeightPx - heightRequiredForTheLabels
        ...
        drawPoints = visibleDataPointsIndices.map {
            ...
            // [Interval -> minYValue - maxYValue] -> [0;1]
