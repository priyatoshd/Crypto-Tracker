...
import com.priyatosh.cryptotracker.crypto.presentation.coin_detail.components.InfoCard
import com.priyatosh.cryptotracker.crypto.presentation.coin_detail.components.LineChart
import com.priyatosh.cryptotracker.crypto.presentation.coin_list.CoinListState
import com.priyatosh.cryptotracker.crypto.presentation.coin_list.components.previewCoin
import com.priyatosh.cryptotracker.crypto.presentation.models.toDisplayableNumber
    ...
    if (state.isLoading) {
        ...
        Column(
            ...
            FlowRow(
                ...
                InfoCard(
                    title = stringResource(id = R.string.text_market_cap),
                    formatedText = "$ ${coin.marketCapUsd.formattedString}",
                    icon = ImageVector.vectorResource(id = R.drawable.stock)
                )
                InfoCard(
                    title = stringResource(id = R.string.text_price),
                    formatedText = "$ ${coin.priceUsd.formattedString}",
                ...
                InfoCard(
                    title = stringResource(id = R.string.text_change_last_24h),
                    formatedText = absoluteChangeFormatted.formattedString,
                    icon = if (isPositive) {
