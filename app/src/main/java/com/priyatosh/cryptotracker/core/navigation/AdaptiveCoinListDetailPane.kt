package com.priyatosh.cryptotracker.core.navigation
...
import com.priyatosh.cryptotracker.crypto.presentation.coin_list.CoinListAction
...
fun AdaptiveCoinListDetailPane(
    ...
    NavigableListDetailPaneScaffold(
        ...
        detailPane = {
            AnimatedPane { CoinDetailScreen(state = state) }
        },
        modifier = modifier
    )
}
